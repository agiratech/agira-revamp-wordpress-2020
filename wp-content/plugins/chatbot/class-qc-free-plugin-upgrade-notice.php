...
if( !class_exists('QcPluginUpgradeToProNotice') )
{
	class QcPluginUpgradeToProNotice {
		...
		function func_qc_external_upgrade_link()
		{
		    ...
		    $link_text = '<span class="qc-up-pro-link-chatbot" style="font-weight: bold; color: '.$this->link_color.'">'.$this->link_text.'</span>';
...
{ 
	...
	$instance_bot2->upgrade_link = "https://www.quantumcloud.com/products/chatbot-for-wordpress/";
	...
	$instance_bot2->plugin_slug = 'wpbot-lite'; //Plugin Slug. i.e. Folder Name
