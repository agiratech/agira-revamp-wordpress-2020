      ...
      >
        ...
        <table style="width:100%;">
          <tr>
            <td style="padding: 10px 0;">
              <span style="color: #7c7d9c;"
                >'.__('Hi', 'wpcal').$hi_name.', <br />'.__('An event has been cancelled.', 'wpcal').'
              </span>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td style="padding: 10px 0;">
              <strong style="font-size: 11px; text-transform: uppercase;"
                >'.__('Cancellation reason', 'wpcal').'</strong
              ><br />
              <span style="color: #7c7d9c;">'.$mail_data['reschedule_cancel_reason'].'</span>
            </td>
          </tr>
          <tr style="'.(!$mail_data['reschedule_cancel_by'] ? 'display:none;' : '').'">
            <td style="padding: 10px 0;">
              <strong style="font-size: 11px; text-transform: uppercase;"
                >'.__('Cancelled by', 'wpcal').'</strong
              ><br />
              <span style="color: #7c7d9c;">'.$mail_data['reschedule_cancel_by'].'</span>
            </td>
          </tr>
        </table>
      </div>
