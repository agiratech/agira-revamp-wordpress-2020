...
$mail_subject = sprintf(
  ...
  __('New Event Confirmed: New event with %1$s at %1$s.', 'wpcal'), $mail_data['booking_admin_display_name'], $mail_data['booking_from_to_time_str_with_tz']);
...
<div
        ...
        <table style="width:100%;">
          ...
          <tr>
            ...
            >
              ...
              href="'.$mail_data['add_event_to_google_calendar_url'].'">'.__('Add to Google Calendar', 'wpcal').' </a
              >&rarr;
            </td>
          </tr>
          <tr>
            ...
            >
              <a style="color: #567bf3; text-decoration: underline;" href="'.$mail_data['download_ics_url'].'"
                >'.__('Add to iCal/Outlook', 'wpcal').' </a
              >&rarr;
            </td>
          </tr>
          <tr>
            ...
            >
              ...
              ><a style="text-decoration: underline;" href="'.$mail_data['cancel_url'].'">'.__('Cancel', 'wpcal').'</a>
            </td>
          </tr>
        </table>
      </div>
    ...
    >
      <a
        ...
        >'.__('Create your own booking page for free', 'wpcal').'</a
      >
    </div>
  </div>
';
