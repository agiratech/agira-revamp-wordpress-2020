...
class WPCal_User_Init{
	...
	public static function enqueue_scripts() {
		...
		wp_enqueue_script( 'wpcal_user_chunk', WPCAL_PLUGIN_DIST_URL . 'js/chunk-vendors.min.js', [], WPCAL_VERSION, true );

		wp_enqueue_script( 'wpcal_user_chunk_common', WPCAL_PLUGIN_DIST_URL . 'js/chunk-common.min.js', ['wp-i18n'], WPCAL_VERSION, true );
		...
		wp_enqueue_script( 'wpcal_user_app', WPCAL_PLUGIN_DIST_URL . 'js/user.min.js', ['wpcal_user_chunk', 'wpcal_user_chunk_common', 'wp-i18n'], WPCAL_VERSION, true );
