...
class WPCal_Admin_Init{
	...
	public static function enqueue_scripts() {
		...
		// } else {
			wp_enqueue_script( 'wpcal_admin_chunk', WPCAL_PLUGIN_DIST_URL . 'js/chunk-vendors.min.js', [], WPCAL_VERSION, false );
			wp_enqueue_script( 'wpcal_admin_chunk_common', WPCAL_PLUGIN_DIST_URL . 'js/chunk-common.min.js', ['wp-i18n'], WPCAL_VERSION, false );
			...
			if(isset($_GET['page']) && $_GET['page'] === 'wpcal_admin' ){
				wp_enqueue_script( 'wpcal_admin_app', WPCAL_PLUGIN_DIST_URL . 'js/admin.min.js', ['wpcal_admin_chunk', 'wpcal_admin_chunk_common', 'wp-i18n'], WPCAL_VERSION, false );
			...
			elseif( 
				...
				wp_enqueue_script( 'wpcal_admin_other_app', WPCAL_PLUGIN_DIST_URL . 'js/admin_other.min.js', ['wpcal_admin_chunk', 'wpcal_admin_chunk_common', 'wp-i18n'], WPCAL_VERSION, false );
	...
	public static function init_admin_menu() {
		...
		if( current_user_can( 'activate_plugins' ) ){
			...
			$submenu['wpcal_admin'][] = [ 'My Bookings', 'manage_options', 'admin.php?page=wpcal_admin#/bookings' ];

			$submenu['wpcal_admin'][] = [ 'Event Types', 'manage_options', 'admin.php?page=wpcal_admin#/event-types' ];

			$submenu['wpcal_admin'][] = [ 'Settings', 'manage_options', 'admin.php?page=wpcal_admin#/settings' ];
		}
