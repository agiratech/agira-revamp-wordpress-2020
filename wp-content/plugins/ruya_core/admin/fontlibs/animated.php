...
function mo_get_icon_params( $add_icon = false, $group = '', $fonts = 'all', $remove = array(), $prefix = 'i_', $dependency = array() ) {
	...
	$font_hash = array(
		'fontawesome'   => esc_html__( 'Font Awesome', 'ruya' ),
		'linea'         => esc_html__( 'mo', 'ruya' ),
		'animated'      => esc_html__( 'Animated', 'ruya' ),
		'image'    => esc_html__( 'Image icon', 'ruya' ),
	);
	...
	if( $add_icon && 'manual' !== $add_icon ) {
		$settings[] = array(
            ...
            'heading'    => esc_html__( 'Add icon?', 'ruya' ),
            'description' => esc_html__( 'Will enable icon on element', 'ruya' ),
		);
	}

// Iconpicker field
	$add_these = $add_these_select = array();
	$add_these_select[esc_html__( 'Select icon font.', 'ruya' )] = '';
	...
	if( ! in_array( 'color', $remove ) ) {
		$settings[] = array(
			...
			'heading'     => esc_html__( 'Icon color', 'ruya' ),
			'description' => esc_html__( 'Select icon color.', 'ruya' ),
	...
	if( ! in_array( 'hcolor', $remove ) ) {
		$settings[] = array(
			...
			'heading'     => esc_html__( 'Icon hover color', 'ruya' ),
			'description' => esc_html__( 'Pick icon hover color.', 'ruya' ),
			'edit_field_class' => 'vc_col-sm-6',
			'dependency'  => ! $add_icon ? $dependency : array(
				'element' => $prefix . 'add_icon',
	            'value'   => 'true'
	...
	if( ! in_array( 'align', $remove ) ) {
		$settings[] = array(
			...
			'heading'    => esc_html__( 'Icon alignment', 'ruya' ),
			'edit_field_class' => 'vc_col-sm-6',
			'value'      => array(
				esc_html__( 'Left', 'ruya' )   => 'left',
				esc_html__( 'Right', 'ruya' )  => 'right'
			),
			'description' => esc_html__( 'Select icon alignment.', 'ruya' ),
			'group' => $group,
			'dependency'  => ! $add_icon ? $dependency : array(
				'element' => $prefix . 'add_icon',
	            'value'   => 'true'
