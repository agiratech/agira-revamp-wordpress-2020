...
jQuery(document).ready(function($) {
	...
	$('#tb_body_background').colpick({
		layout:'rgbhex',
		colorScheme:'dark',
		submit:0,
		onChange:function(hsb,hex,rgb,el,bySetColor) {
			$(el).css('tb_body_background','#'+hex);
	...
	$("#tb_header").change(function() {
		headerChange(this);
	});
	function headerChange(obj){
		var header = $(obj).val();
		if(header=='header_transparent'){
			$('#tb_metabox_field_logo_header_transparent,#tb_metabox_field_menu_color_header_transparent,#tb_metabox_field_background_color_menu_header_transparent,#tb_metabox_field_bg_opacity_menu_header_transparent').show();
		}else{
			$('#tb_metabox_field_logo_header_transparent,#tb_metabox_field_menu_color_header_transparent,#tb_metabox_field_background_color_menu_header_transparent,#tb_metabox_field_bg_opacity_menu_header_transparent').hide();
		}
	}
