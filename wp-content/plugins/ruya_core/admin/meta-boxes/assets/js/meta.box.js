jQuery(document).ready(function($) {
	"use strict";
	function motivowebDatePicker() {
		if ($('.tb_metabox_field .mo-date-picker').length) {
			$('.tb_metabox_field .mo-date-picker').datepicker();
		}
	}
	motivowebDatePicker();
	...
	motivowebDatePicker();
	/*
	$('#post-format-selector input').change(checkformat);
	...
	function checkformat() {
		...
		var format = $('#post-format-selector input:selected').attr('value');
		var i = 0;
