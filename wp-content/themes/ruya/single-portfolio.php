<?php get_header(); 
global $ruya_options;
$tb_portfolio_layout = isset($ruya_options['tb_portfolio_layout']) ? $ruya_options['tb_portfolio_layout'] : '2cl';
...
$tb_portfolio_show_nav = (int) isset($ruya_options['tb_portfolio_show_nav']) ? $ruya_options['tb_portfolio_show_nav'] : 1;
$tb_related_portfolio = (int) isset($ruya_options['tb_related_portfolio']) ? $ruya_options['tb_related_portfolio'] : 1;
$tb_portfolio_full_thumbnail = (int) isset($ruya_options['tb_portfolio_full_thumbnail']) ? $ruya_options['tb_portfolio_full_thumbnail'] : 1;
?>
	            ...
	            <div class="container portfolio-full thumb-content">
	                ...
	                <div class="meta-wrap">
					  <ul class="meta-post meta-portfolio">
					   <?php if (isset($ruya_options['tb_portfolio_meta_single']) && is_array($ruya_options['tb_portfolio_meta_single']) && in_array('date', $ruya_options['tb_portfolio_meta_single'])) {  ?>
						<li><i class="fa fa-clock-o"></i><?php echo get_the_date(); ?></li>
			           <?php } ?>
                       <?php if (isset($ruya_options['tb_portfolio_meta_single']) && is_array($ruya_options['tb_portfolio_meta_single']) && in_array('author', $ruya_options['tb_portfolio_meta_single'])) {  ?>
						<li><i class="fa fa-user-o"></i><?php echo esc_html__('By ', 'ruya').get_the_author(); ?></li>
			           <?php } ?>
					   <?php if (isset($ruya_options['tb_portfolio_meta_single']) && is_array($ruya_options['tb_portfolio_meta_single']) && in_array('cat', $ruya_options['tb_portfolio_meta_single'])) {  ?>
						<li><i class="fa fa-folder-open-o"></i><?php the_terms( get_the_ID(), 'project-type' ); ?></li>
					   <?php } ?>
					   <?php if (isset($ruya_options['tb_portfolio_meta_single']) && is_array($ruya_options['tb_portfolio_meta_single']) && in_array('view', $ruya_options['tb_portfolio_meta_single'])) {  ?>
			    ...
			    <?php } ?>
		         ...
		         <div class="row">
		         	<div class="col-md-8 col-xs-12">
					    <?php if (isset($ruya_options['tb_portfolio_meta_single']) && is_array($ruya_options['tb_portfolio_meta_single']) && in_array('share', $ruya_options['tb_portfolio_meta_single'])) {  ?>
							<div class="portfolio_share"><?php echo ruya_post_share_buttons(); ?> </div>
					     <?php } ?>
		         	</div>
		         	<div class="col-md-4 col-xs-12">
					    <?php if (function_exists('ruya_like') && isset($ruya_options['tb_portfolio_meta_single']) && is_array($ruya_options['tb_portfolio_meta_single']) && in_array('like', $ruya_options['tb_portfolio_meta_single'])) {  ?>
							<div class="blog_like"><?php echo ruya_like(); ?></div>
						<?php } ?>
		         	</div>
		         </div>
			    </div>
	   ...
	   <?php if($tb_related_portfolio){ ?>
			...
			<?php
			    ...
			    <div class="related-posts"> 
					<h3 class="title"><?php esc_html_e('Related Posts','ruya'); ?></h3>
					...
					<?php $title=get_the_title();
					  ...
					  <div class="col-md-4 col-sm-4 col-xs-12">
						<div class="related-post">
							<figure>								   
							   <?php if ( has_post_thumbnail() ) the_post_thumbnail('ruya-small'); ?>
							 </figure>
							<div class="info-post">
								<h6><a href="<?php echo get_the_permalink(); ?>"> <?php the_title(); ?></a></h6>
								<ul class="meta-post"><i class="fa fa-folder-open-o"></i><li><?php the_terms( get_the_ID(), 'project-type'); ?></li> </ul>
							</div>
						</div><!-- related-post  -->
					  </div><!-- col -->
					<?php endwhile; ?> 
