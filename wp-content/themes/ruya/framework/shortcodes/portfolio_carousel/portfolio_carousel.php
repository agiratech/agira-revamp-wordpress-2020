<?php
function ruya_portfolio_carousel_func($atts, $content = null) {
...
if(function_exists('ruya_shortcode')) { ruya_shortcode('portfolio_carousel', 'ruya_portfolio_carousel_func'); }