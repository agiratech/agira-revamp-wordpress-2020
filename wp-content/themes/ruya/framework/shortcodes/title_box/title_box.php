<?php
function ruya_title_box_func($atts, $content = null) {
    extract(shortcode_atts(array(
		'title' => '',
		'subtitle' => '',
		'position' => 'text-center',
		'content_box' => '',
		'ruya_template' => 'title-box-style1',
		// animation
		'enable_split' => '',        
		'split_type' => 'words',          
		'duration' => '1200',
...
if(function_exists('ruya_shortcode')) { ruya_shortcode('title_box', 'ruya_title_box_func');}