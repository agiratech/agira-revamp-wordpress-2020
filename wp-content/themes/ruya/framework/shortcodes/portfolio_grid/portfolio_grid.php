<?php
function ruya_portfolio_grid_func($atts, $content = null) {
	...
	$html.="</div>"; 
	$html.= ruya_pagination($wp_query, $typenavigation);
	$html.="</div><!--End .more-posts-wrapper -->"; 
    return $html;
} 
if(function_exists('ruya_shortcode')) { ruya_shortcode('portfolio_grid', 'ruya_portfolio_grid_func'); }