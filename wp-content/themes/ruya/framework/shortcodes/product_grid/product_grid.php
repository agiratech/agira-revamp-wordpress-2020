<?php
function ruya_products_grid_render($atts) {
    ...
    $class = array();
    $class[] = 'woocommerce mo-products-grid';
    $class[] = $tpl;
	$class[] = $el_class;
...
if(function_exists('ruya_shortcode')) { ruya_shortcode('products_grid', 'ruya_products_grid_render'); }