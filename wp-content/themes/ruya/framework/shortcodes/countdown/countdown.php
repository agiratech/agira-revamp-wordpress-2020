<?php
function ruya_countdown_func($params, $content = null) {
	...
	wp_enqueue_script('countdown', RUYA_URI_PATH . '/assets/js/countdown.min.js');
	$class = array();
	$class[] = $style;
	$class[] = $el_class;
    ob_start(); ?>
...
if(function_exists('ruya_shortcode')) { ruya_shortcode('countdown', 'ruya_countdown_func'); }