<?php
function ruya_product_carousel_func($atts, $content = null) {
    ...
    $class = array();
    $class[] = 'woocommerce mo-product-carousel clearfix';
    $class[] = $tpl;
    ...
    <?php
		...
		echo _e('Post not found!', 'ruya');
    }
	wp_reset_postdata();
    return ob_get_clean();
}
if(function_exists('ruya_shortcode')) { ruya_shortcode('product_carousel', 'ruya_product_carousel_func'); }