...
function motivoweb_blog_func($atts, $content = null) {
	...
	if ( $wp_query->have_posts() ) {
		...
		switch ($columns) {
			...
			case 2:
				...
				break;
			case 3:
				$class_columns[] = 'col-xs-12 col-sm-6 col-md-6 col-lg-4 ';
				break;
			case 4:
    ...
    <div class="blog-posts more-posts-wrapper"> 
			...
			<?php echo ruya_pagination($wp_query, $pagination); ?>
...
if(function_exists('ruya_shortcode')) { ruya_shortcode('blog', 'motivoweb_blog_func'); }