<?php
function ruya_maps_render($params) {
    ...
    wp_enqueue_script('maps-api', RUYA_URI_PATH_FR . "/shortcodes/map/maps.js",array(),'1.0.0');
    /* Map Style defualt */
    $map_styles = array(
    ...
    if($markercoordinate){
    	...
    	$marker->markerdesc = 	'<div class="mo-maps-info-content">'.
...
if(function_exists('ruya_shortcode')) { ruya_shortcode('maps', 'ruya_maps_render'); }