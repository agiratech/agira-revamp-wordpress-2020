<?php
function ruya_team_carousel_func($atts, $content = null) {
...
if(function_exists('ruya_shortcode')) { ruya_shortcode('team_carousel', 'ruya_team_carousel_func'); }
    ...
    ob_start();  ?>
	 <figure class="team-member"> 
	   <?php 
		  ...
		  if($attachment_image[0]) { echo '<div class="team-img"><img src="'.esc_url($attachment_image[0]).'" alt="'.esc_html($name).'"/></div>';
		} ?>
...
if(function_exists('ruya_shortcode')) { ruya_shortcode('single_team_carousel', 'motivoweb_single_team_carousel_func'); }