...
<?php 
	...
	if(isset($ruya_options['fixed_main_menu_v1']) && $ruya_options['fixed_main_menu_v1']) {
		$class_header .= ' mo-header-fixed';
	}
	$layout_menu_v1 =& $ruya_options["layout_menu_v1"];
...
?>
<header id="header">
      <div id="mo_header" class="mo-header-v1 <?php echo esc_attr($class_header); ?> <?php echo esc_attr($layout_menu_v1); ?>">
		 ...
		 <div class="side-bar">
			<div class="menu-toggle">
			   ...
			   <span class="navbar-toggler-label"><?php echo esc_html__( 'Menu', 'ruya' ); ?></span>
		    </div>
		    <?php $switch_header_social_v1 =& $ruya_options["switch_social_v1"];
      ...
      <div class="mo-sidepanel-v1 sidepanel <?php echo esc_attr($layout_menu_v1); ?>_anim full-nav <?php echo esc_attr($layout_menu_v1); ?>">
           <a id="menu-close" href="#" class="close-btn"><span></span></a>
            ...
            <?php if(isset($ruya_options['text_v1']) AND $ruya_options['text_v1'] !='') { ?>
			    <div class="text_v1"> <div class="text_content_v1"><?php echo wptexturize($ruya_options['text_v1']);?></div></div>
		    <?php } ?>
      </div>
</header>