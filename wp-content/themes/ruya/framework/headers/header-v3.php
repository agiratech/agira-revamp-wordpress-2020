...
<?php 
	...
	if($disable_stick_menu != 'on') {
		if(isset($ruya_options['fixed_main_menu_v3']) && $ruya_options['fixed_main_menu_v3']) {
			$class_header .= ' mo-header-stick';
		}
	}
    $menu_color_v3 =& $ruya_options["menu_first_level_color_v3"];
    $menu_color_stick_v3 =& $ruya_options["menu_first_level_color_stick_v3"];
?>
<header id="mo_header" class="<?php echo esc_attr($class_header); ?>">
 <div class="mo-header-menu <?php echo esc_attr($menu_color_v3); ?> <?php echo esc_attr($menu_color_stick_v3); ?>">
	  <div class="container-fluid ">
		...
		<div class="logo"><a href="<?php echo esc_url(home_url('/')); ?>"><?php ruya_logo(); ?></a></div>
		<nav>
		...
		<div class="nav-menu-icon">
			<a href="javascript:void(0)"><div class="menu-icon"><div><?php echo esc_html__('Menu', 'ruya'); ?></div><span></span><span></span></div></a>
