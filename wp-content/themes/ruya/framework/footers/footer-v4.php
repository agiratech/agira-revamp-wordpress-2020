...
<?php $footer_v4_to_top =& $ruya_options["tb_footer_v4_to_top"]; ?>
<?php if($footer_v4_to_top == 1){ ?>
<a href="#" id="back-to-top">
  <div class="arrow-top"></div><div class="arrow-top-line"></div>
</a>
<?php } ?>

<?php $footer_v4_fixed =& $ruya_options["tb_footer_v4_fixed"]; ?>
<footer class="footer footer_v4 <?php if($footer_v4_fixed == 1){ echo "footer-fixed"; }?>"> 
   <div class="container">
    <div class="row">
