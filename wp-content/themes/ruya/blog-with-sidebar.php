...
padding-top: 20px;
	...
	.sidebar-right .feedback_form_area_inner {
    margin-top: -80px;
    height: 500px;
}
...
?>
<div class="blog-sidebar-content main-content">
	<div class="mo-media <?php echo get_post_format(); ?>">
	 <?php while ( have_posts() ) : the_post(); ?>
		...
		<!-- Start Content -->
		<div class="<?php echo esc_attr($cl_content) ?> content mo-blog blog-sidebar-mo-blog">
...
<!-- 					<li><i class="fa fa-comments-o"></i><a href="<?php //comments_link(); ?>"><?php //comments_number( '0', '1', '%' ); echo esc_html__(' Comment', 'ruya'); ?></a></li>   -->
				...
				<?php } ?>
					 ...
					 <div class="single-header img_overlay blog-template-overlay">
    <?php $image_link = get_the_post_thumbnail_url(get_the_ID(),'full');  ?>
	 
 
		 <div class="blog-hero blog-template-img" style="background-image: url(<?php echo esc_url($image_link); ?>);" ></div>
