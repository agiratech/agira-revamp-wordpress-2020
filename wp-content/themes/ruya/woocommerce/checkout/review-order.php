...
<div class="shop_table woocommerce-checkout-review-order-table">
	<h3 class="order-review-heading"><?php esc_html_e( 'Your order', 'ruya' ); ?></h3>
	<ul>
		<li class="header">
			<span class="col-left product-name"><?php esc_html_e( 'Product', 'ruya' ); ?></span>
			<span class="col-right product-total"><?php esc_html_e( 'Total', 'ruya' ); ?></span>
		</li>
		<?php
		...
		<li class="cart-subtotal">
			<span class="col-left"><?php esc_html_e( 'Subtotal', 'ruya' ); ?></span>
		...
		<li class="order-total">
			<span class="col-left"><?php esc_html_e( 'Total', 'ruya' ); ?></span>
