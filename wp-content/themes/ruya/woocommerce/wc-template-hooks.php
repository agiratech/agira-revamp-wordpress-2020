 ...
 */
add_action( 'woocommerce_template_single_add_to_cart', 'woocommerce_template_single_add_to_cart', 40 );
/**
 * @hooked woocommerce_template_single_meta - 40
 */
add_action( 'woocommerce_template_single_meta', 'woocommerce_template_single_meta', 40 );
/**
 * @hooked woocommerce_template_single_meta_top - 40
 */
add_action( 'woocommerce_template_single_meta_top', 'woocommerce_template_single_meta_top', 40 );
/**
