...
<?php ruya_header(); ?>
    ...
    <a class="feedback-form-btn btn button light hr_light bg_gradient bg_hr_primary large radius0 btn-lg" id="OpenForm">Say Hello!</a>
    <div class="feedback_form_area">
    <div class="feedback_form_area_inner">	<a class="toggleclose">&times;</a>
    <h3>Get In Touch!</h3>
